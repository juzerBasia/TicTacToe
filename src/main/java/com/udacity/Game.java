...
//horizontal
        if (checkMore) {
            for (int i = 0; i < grid[0].length; i++) {
                if (grid[0][i] == grid[1][i] && grid[1][i] == grid[2][i] && grid[2][i]!= empty) {
...
//diagonal
        if (checkMore) {
            if (grid[0][0] == grid[1][1] && grid[2][2] == grid[1][1]&& grid[1][1]!= empty) {
                result = grid[0][0] + " wins";
                checkMore = false;
            }
        }
        if (checkMore) {
            if (grid[2][0] == grid[1][1] && grid[0][2] == grid[1][1] && grid[1][1]!= empty) {
